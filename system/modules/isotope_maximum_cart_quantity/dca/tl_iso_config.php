<?php
  ...
  **/
  ...
  $GLOBALS['TL_DCA']['tl_iso_config']['palettes']['default'] = str_replace('{analytics_legend}', '{maximum_cart_quantity_legend},maxCartQuantity,maxCartMessage;{analytics_legend}', $GLOBALS['TL_DCA']['tl_iso_config']['palettes']['default']);
